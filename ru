...
xkb_symbols "rud" {
    ...
    key <AD07> { [  Cyrillic_ghe,      Cyrillic_GHE  ] };
    key <AD08> { [  Cyrillic_tse,      Cyrillic_TSE,      Cyrillic_che,      Cyrillic_CHE ] }; // Ч
    ...
    key <AC02> { [  Cyrillic_o,        Cyrillic_O,        Cyrillic_io,       Cyrillic_IO  ] }; // Ё
    key <AC03> { [  Cyrillic_ie,       Cyrillic_IE,       Cyrillic_e,        Cyrillic_E   ] }; // Э
    key <AC04> { [  Cyrillic_u,        Cyrillic_U,        Cyrillic_yu,       Cyrillic_YU  ] }; // Ю
    ...
    key <AC10> { [  Cyrillic_es,       Cyrillic_ES,       Cyrillic_sha,      Cyrillic_SHA ] }; // Ш
    ...
    key <AB06> { [  Cyrillic_be,       Cyrillic_BE,       Cyrillic_hardsign, Cyrillic_HARDSIGN  ] }; // На AltGr - Ъ
